...
<section class="py-5" style="background: white;">
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="h-100">
                    <h5 class="mb-4 pb-2 border-bottom" style="color: #1e3a8a; font-weight: 600; font-size: 1rem; border-bottom-width: 2px !important; border-bottom-color: #1e3a8a !important;">
                        Recent Posts
                    </h5>
                    ...
                    <div class="news-list">
                        ...
                        <div class="d-flex mb-3 pb-3 border-bottom" style="border-color: #e2e8f0 !important;">
                            ...
                            <div>
                                ...
                                <div class="mt-1" style="font-size: 0.7rem; color: #6b7280;">
                                    <i class="far fa-calendar me-1"></i> Jan 15, 2026
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex mb-3 pb-3 border-bottom" style="border-color: #e2e8f0 !important;">
                            ...
                            <div>
                                ...
                                <div class="mt-1" style="font-size: 0.7rem; color: #6b7280;">
                                    <i class="far fa-calendar me-1"></i> Jan 10, 2026
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex mb-3 pb-3 border-bottom" style="border-color: #e2e8f0 !important;">
                            ...
                            <div>
                                ...
                                <div class="mt-1" style="font-size: 0.7rem; color: #6b7280;">
                                    <i class="far fa-calendar me-1"></i> Jan 05, 2026
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex mb-3 pb-3 border-bottom" style="border-color: #e2e8f0 !important;">
                            ...
                            <div>
                                ...
                                <div class="mt-1" style="font-size: 0.7rem; color: #6b7280;">
                                    <i class="far fa-calendar me-1"></i> Dec 28, 2025
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <div class="mt-1" style="font-size: 0.7rem; color: #6b7280;">
                                    <i class="far fa-calendar me-1"></i> Dec 20, 2025
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="h-100">
                    ...
                    <div class="announcement-list">
                        <!-- Announcement 1 -->
                        <div class="mb-3 pb-3 border-bottom" style="border-color: #e2e8f0 !important;">
