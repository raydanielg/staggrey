<!-- Hero Section -->
<section class="hero-section position-relative" style="min-height: 600px; background: linear-gradient(135deg, rgba(30, 58, 138, 0.95) 0%, rgba(37, 99, 235, 0.9) 100%), url('https://images.unsplash.com/photo-1562774053-701939374585?w=1920&h=800&fit=crop') center/cover no-repeat;">
    ...
    <div class="container position-relative" style="z-index: 2;">
        <div class="row align-items-center min-vh-600" style="min-height: 600px; padding: 80px 0;">
            <div class="col-lg-7 text-white">
                <div class="mb-3">
                    <span class="badge px-3 py-2" style="background: #f59e0b; color: #1e3a8a; font-size: 0.85rem; font-weight: 600;">
                        <i class="fas fa-star me-1"></i> QUALITY EDUCATION IN TANZANIA
                    </span>
                </div>
                ...
                <p class="lead mb-4 opacity-90" style="max-width: 600px;">
                    ...
                    Join us for certificate and diploma programs that prepare you for a successful career.
                </p>
                ...
                <div class="row g-4 text-center">
                    <div class="col-4">
                        <div class="p-3 rounded" style="background: rgba(255,255,255,0.1); backdrop-filter: blur(10px);">
                            <h3 class="fw-bold mb-1" style="color: #fbbf24;">15+</h3>
                            <small class="opacity-75">Years Experience</small>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="p-3 rounded" style="background: rgba(255,255,255,0.1); backdrop-filter: blur(10px);">
                            <h3 class="fw-bold mb-1" style="color: #fbbf24;">500+</h3>
                            <small class="opacity-75">Active Students</small>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="p-3 rounded" style="background: rgba(255,255,255,0.1); backdrop-filter: blur(10px);">
                            <h3 class="fw-bold mb-1" style="color: #fbbf24;">6+</h3>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                <a href="#" class="quick-link-card text-center text-decoration-none p-3 rounded d-block" style="background: linear-gradient(135deg, #e0e7ff 0%, #c7d2fe 100%); transition: all 0.3s ease;">
                                    <i class="fas fa-book fa-2x mb-2" style="color: #4f46e5;"></i>
                                    <small class="d-block fw-semibold" style="color: #4338ca;">Library</small>
                                </a>
                            </div>
                            <div class="col-6">
                                <a href="#" class="quick-link-card text-center text-decoration-none p-3 rounded d-block" style="background: linear-gradient(135deg, #fed7aa 0%, #fdba74 100%); transition: all 0.3s ease;">
                                    <i class="fas fa-graduation-cap fa-2x mb-2" style="color: #c2410c;"></i>
                                    <small class="d-block fw-semibold" style="color: #9a3412;">Alumni</small>
                                </a>
                            </div>
                        </div>
                    </div>
